...
namespace gps {
    ...
    void SkyBox::Draw(Shader shader, glm::mat4 viewMatrix, glm::mat4 projectionMatrix)
	{
        ...
        glUniformMatrix4fv(glGetUniformLocation(shader.GetShaderProgram(), "view"), 1, GL_FALSE, glm::value_ptr(transformedView));
        glUniformMatrix4fv(glGetUniformLocation(shader.GetShaderProgram(), "projection"), 1, GL_FALSE, glm::value_ptr(projectionMatrix));
    ...
    GLuint SkyBox::LoadSkyBoxTextures(std::vector<std::string> skyBoxFaces)
    {
        GLuint textureID;
